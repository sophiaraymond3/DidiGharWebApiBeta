...
using DidiGharWebApi.Providers;
using DidiGharWebApi.Results;
using System.Linq;
using System.Text;
using BCrypt.Net;
...
namespace DidiGharWebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        //[Route("VerifyGmailUser")]
        //public async Task<> VerifyGmailUser(AuthUsers authUser)
        //{
        //    var user = db.AppUsers.FirstOrDefault(x => x.Email == authUser.Email);
        //    if(user != null)
        //    {
        //        if(user.PhoneNumber != null && user.PhoneNumber > 0)
        //        {
        //            return Json(new { verified = true, complete = true })
        //        }
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var normaluser = new DidiGharWebApi.Data.User
            {
                ...
                UserCrerdsId = user.Id
            };
            db.AppUsers.Add(normaluser);
        ...
        //POST api/Account/RegisterPartner
        [AllowAnonymous]
        [Route("RegisterPartner")]
        public async Task<IHttpActionResult> RegisterPartner(RegisterBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            try
            {
                if (!db.ServiceProviders.Any(x => x.Email == model.Email))
                {
